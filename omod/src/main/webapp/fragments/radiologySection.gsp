...
<div class="info-section">
    <div class="info-header">
        ...
        <a href='${ui.pageLink("coreapps", "patientdashboard/radiologyDashboard", [patientId: patient.id, returnUrl: ui.urlBind("/" + contextPath + dashboardUrl, [ patientId: patient.patient.id ] )])}' class="right">
